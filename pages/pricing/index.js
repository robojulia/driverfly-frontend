...
<div className="top-links-sec">
   <div className="container">
    ...
    <div className={Pric.pricesec}></div>
            ...
            <div className={Pric.services}>
                ...
                <div class="row">
                    <div class="col-sm my-5">
                        <h3>Spending less time searching.</h3>
                        <p> We know you’ve got a business to run. Don’t spend all your time searching the depths of the internet when you can find you next hire here! Access hundreds of qualifying candidates today.</p>
                    </div>
                    <div class="col-sm my-5">
