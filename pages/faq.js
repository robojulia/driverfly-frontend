            ...
            <div class="faq-sec">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="faq-inner pl-3">
                                <form action="#" method="#">
                                    <div class="input-group shadow-sm">
                                        <input type="text" placeholder="Search" name="s" class="form-control border-0  p-4 " />
                                        ...
                                        <input type="hidden" name="post_type" value="post" class="post_type p-4" />
                                    </div>
                                </form>
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="faq-outer">
                                <h2 class="mt-0 pb-3 font-weight-normal">Frequently Asked Questions</h2>
