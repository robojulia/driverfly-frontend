                            ...
                            <div className="row border-bottom pb-3">
                                <div className="col-lg-4 col-md-4 p-0  ">
                                    ...
                                    <div className={Blog.cusbtn}>
                                        <button className="form-control bt btn-lg mt-2 ml-3 text-center text-white">Changes in Trucking</button>
                                    </div>
                                </div>
                                <div className="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                    <div className={Blog.topinfo}>
                                        ...
                                        <a className={Blog.time} href="#"><Clock />January 26, 2022</a>
                                        <span className={Blog.comments}><Chat /> 0 Comments</span>
                                        ...
                                        <a href="/blog-eldt" className={`${Blog.readmore} hvr-underline-reveal`}>Read More <ArrowRight /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='my-3'>
                            <div className='row border-bottom pb-3'>
                                <div className="col-lg-4 col-md-4 p-0  ">
                                    ...
                                    <div className={Blog.custombtn}></div>
                                    <div className={Blog.cusbtn}>
                                        <button className="form-control bt btn-lg mt-2 ml-3 text-center text-white">Tips and Tricks</button>
                                    </div>
                                </div>
                                <div className="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                    <div className={Blog.topinfo}>
                                        ...
                                        <a href="/blog-tips" className={`${Blog.readmore} hvr-underline-reveal`}>Read More <ArrowRight /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
