...
export async function getServerSideProps({ query }) {
  try {
    ...
    const applicant: ApplicantEntity = await applicantApi.fetchByUuidToken(applicant_uuid, {
      withRelations: ['company', 'employers', 'employers.voeData'],
    });
    const employer: ApplicantEmployerEntity = applicant.employers.find(
      ({ uuid_token }) => uuid_token == employer_uuid
    );
