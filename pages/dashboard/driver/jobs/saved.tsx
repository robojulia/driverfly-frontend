            ...
            <ViewDataTable<SavedJobEntity>
                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        selector: v => `${v.job.min_weekly_pay ? v.job.min_weekly_pay : 0} - ${v.job.max_weekly_pay ? v.job.max_weekly_pay : 0}`,
                        cell: v =>
                    ...
                    },
                    {
                        id: "license_type",
                        name: "LICENSE_TYPE",
                        selector: v => v.job.cdl_class ? t(`DriverLicenseType.${v.job.cdl_class}`) : null,
                        cell: v =>
                        (<ShowEnumFromString
                    ...
                    },
                    {
                        ...
                        selector: v => v.job.expiry_date ? new Date(v.job.expiry_date).toDateString() : null,
                        cell: v =>
                            v.job.expiry_date ?
                    ...
                    },
                    {
                        id: "schedule",
                        name: "SCHEDULE",
                        selector: v => v.job.schedule ? t(`JobSchedule.${v.job.schedule}`) : null,
                        cell: v =>
                    ...
                    },
                    {
                        ...
                        selector: v => v.job.employment_type ? t(`JobEmploymentType.${v.job.employment_type}`) : null,
                        cell: v =>
                    ...
                    },
                    {
                        id: "delivery_type",
                        name: "DELIVERY_TYPE",
                        selector: v => v.job.delivery_type ? t(`JobDeliveryType.${v.job.delivery_type}`) : null,
                        cell: v =>
                        (<ShowEnumFromString
                    ...
                    },
                    {
                        id: "team_drivers",
                        name: "TEAM_DRIVERS",
                        selector: v => v.job.team_drivers ? t(`JobTeamDriver.${v.job.team_drivers}`) : null,
                        cell: v =>
                            (<OverlyPopover labelPrefix="JobTeamDriver" skipTranslate={false} str={v.job.team_drivers} />),
                    },
                ]}
                items={savedJobs}
