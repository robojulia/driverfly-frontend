                    ...
                    <ViewDataTable<ApplicantJobEntity>
                        columns={[
                            ...
                            },
                            {
                                ...
                                selector: applicant => buildAddress(applicant.job.location || {}),
                            },
                            {
                                name: "drivers_needed",
                            ...
                            },
                            {
                                ...
                                selector: applicant => `${applicant.job.min_weekly_pay ? applicant.job.min_weekly_pay : 0} - ${applicant.job.max_weekly_pay ? applicant.job.max_weekly_pay : 0}`,
                            },
                            {
                                name: "LICENSE_TYPE",
                                cell: applicant =>
                            ...
                            },
                            {
                                ...
                                cell: applicant =>
                                    applicant.job.expiry_date ?
                                        ...
                                        : null,
                                selector: applicant => applicant.job.expiry_date ? new Date(applicant.job.expiry_date).toDateString() : "",
                            },
                            {
                                name: "SCHEDULE",
                                cell: applicant =>
                                    (<OverlyPopover labelPrefix="JobSchedule" skipTranslate={false} header={t('SCHEDULE')} str={applicant.job.schedule} />),
                                selector: applicant => t(`JobSchedule.${applicant.job.schedule}`),
                            },
                            {
                                ...
                                selector: applicant => t(`JobEmploymentType.${applicant.job.employment_type}`),
                            },
                            {
                                name: "DELIVERY_TYPE",
                                cell: applicant =>
                            ...
                            },
                            {
                                ...
                                selector: applicant => t(`JobTeamDriver.${applicant.job.team_drivers}`),
                            },
                        ]}
                        items={applications}
