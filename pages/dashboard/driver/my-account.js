...
export default function MyAccount() {
    ...
    return (
        <>
                            ...
                            <form className="modal-body" onSubmit={contactForm.handleSubmit} >
                                ...
                                <div className='row'>
                                    ...
                                    <BaseInputPhone
                                        ...
                                        onChange={(value, country, e, formattedValue) => { contactForm.setFieldValue('contact_number', formattedValue) }}
                                        handleBlur={(event, data) => { contactForm.setFieldValue('contact_number', event.target.value) }}
                                        onKeyDown={(event) => { contactForm.setFieldValue('contact_number', event.target.value) }}
                                    />
                                    {/* <BaseInput
                                        className="col-md-6 mt-3"
                                        label={t("phone")}
                                    ...
                                    <BaseInputPhone
                                        ...
                                        touched={contactForm.touched.user?.cell_number}
                                        error={contactForm.errors.user?.cell_number}
                                        onChange={(value, country, e, formattedValue) => { contactForm.setFieldValue('cell_number', formattedValue) }}
                                        handleBlur={(event, data) => { contactForm.setFieldValue('cell_number', event.target.value) }}
                                        onKeyDown={(event) => { contactForm.setFieldValue('cell_number', event.target.value) }}
                                    />
            ...
            {/* <Tabs className="account_tabs">
                <TabList>
                    <Tab>{t("my_account")}</Tab>
                    <Tab>{t("communication_preferences")}</Tab>
                    <Tab>{t("matching_preferences")}</Tab>
                </TabList>
            ...
            {/* <span className="mt-5 d-block">{t("delete_account_paragraph", { email: "support@driverfly.co" })} </span> */}
