import { ArrowLeft,ArrowsExpand, ChevronUp, Pencil, PlusCircle, PlusCircleFill, XCircle, XCircleFill} from 'react-bootstrap-icons';
 ...
 function Edit(props) {
    ...
    const form = useFormik({
        initialValues: {
            ...
            psp_violations: false,
            tickets: false,
            positive_drug_test: false,
                                        ...
                                        <Table striped>
                                            ...
                                            <tbody>
                                                {form.values
                                                    ...
                                                    .map((entity, i) => (
                                                        <tr key={i}>
                                                            <td colSpan={entity.type === JobEquipmentType.OTHER ? 1 : 2}>
                                                                <BaseSelect
