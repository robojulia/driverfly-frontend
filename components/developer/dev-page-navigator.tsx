    ...
    switch (formType) {
      case 'full':
        return [
          ...
          { step: 20, name: 'Worked Before', component: 'WorkedBefore', section: 'Long Form' },
          {
            step: 21,
          ...
          { step: 23, name: 'Past Suspension', component: 'PastSuspension', section: 'Long Form' },
          { step: 24, name: 'Unable For Job', component: 'UnableForJob', section: 'Long Form' },
          {
            step: 25,
          ...
          { step: 26, name: 'Drug Test', component: 'DrugTest', section: 'Long Form' },
          {
            step: 27,
          ...
          { step: 28, name: 'Thank You', component: 'ThankyouPage', section: 'Complete' },
        ];
