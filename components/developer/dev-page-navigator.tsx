    ...
    switch (formType) {
      case 'full':
        return [
          ...
          { step: 9, name: 'Hear About', component: 'HearAbout', section: 'Short Form' },
          {
            step: 10,
          ...
          { step: 12, name: 'Background Info', component: 'BackgroundInfo', section: 'Long Form' },
          { step: 13, name: 'Education', component: 'HighestLevelEducation', section: 'Long Form' },
          {
            step: 14,
          ...
          { step: 15, name: 'Other Questions', component: 'OtherQueues', section: 'Long Form' },
          { step: 16, name: 'Driver License', component: 'DriverLicense', section: 'Long Form' },
          { step: 17, name: 'Medical Card', component: 'MedicalCard', section: 'Long Form' },
          {
            step: 18,
          ...
          { step: 21, name: 'Worked Before', component: 'WorkedBefore', section: 'Long Form' },
          {
            step: 22,
          ...
          { step: 24, name: 'Past Suspension', component: 'PastSuspension', section: 'Long Form' },
          { step: 25, name: 'Unable For Job', component: 'UnableForJob', section: 'Long Form' },
          {
            step: 26,
          ...
          { step: 27, name: 'Drug Test', component: 'DrugTest', section: 'Long Form' },
          {
            step: 28,
          ...
          { step: 29, name: 'Thank You', component: 'ThankyouPage', section: 'Complete' },
        ];
      ...
      case 'long':
        return [
          ...
          { step: 10, name: 'Worked Before', component: 'WorkedBefore', section: 'Long Form' },
          {
            step: 11,
            name: 'Accident History',
            component: 'AccidentHistory',
          ...
          { step: 13, name: 'Past Suspension', component: 'PastSuspension', section: 'Long Form' },
          { step: 14, name: 'Unable For Job', component: 'UnableForJob', section: 'Long Form' },
          {
            step: 15,
            name: 'Felony Conviction',
            component: 'FelonyConviction',
          ...
          { step: 16, name: 'Drug Test', component: 'DrugTest', section: 'Long Form' },
          {
            step: 17,
            name: 'Legal Documents',
            component: 'LegalDocumentsPage',
          ...
          { step: 19, name: 'Thank You', component: 'ThankyouPage', section: 'Complete' },
        ];
