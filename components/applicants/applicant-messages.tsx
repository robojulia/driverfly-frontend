...
export interface ApplicantMessagesProps {
...
export function ApplicantMessages({ applicant }: ApplicantMessagesProps) {
  ...
  // Fetch conversation for this applicant
  useEffect(() => {
    const fetchConversation = async () => {
      ...
      try {
        ...
        // Find conversation for this applicant
        const existingConversation = conversations.find(
          (c) => c.chattable_type === ChattableType.APPLICANT && c.chattable_id === applicant.id
        );
      ...
      try {
        ...
        if (!conv) {
          conv = await conversationApi.create({
            ...
            chattable_name: `${applicant.first_name} ${applicant.last_name}`,
  ...
  if (loading) {
    return (
      <Card className="w-100">
        ...
        <Card.Body className="my_card_body">
  ...
  return (
    <Card className="w-100">
      ...
      <Card.Body className="my_card_body p-0">
        <Card>
