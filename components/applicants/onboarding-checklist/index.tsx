                                    ...
                                    return (
                                        <tr key={i}>
                                            ...
                                            {Boolean(props.showCompleted)
                                                &&
                                                <td colSpan={1} className="text-center">
                                                    <input className="" type="radio" disabled checked={Boolean(dac?.type && dac.type == value && dac.value)} />
                                                </td>
                                            }
                                            <td colSpan={2}>
                                                {dac?.last_updated_at
                                                        ...
                                                        (dacForm.values.type != value) ? (
                                                            <div className="d-flex justify-content-between">
                                                                <Button
                                                                    className="ml- w-100"
                                                                    disabled={form.isSubmitting || !form.isValid || form.isValidating}
                                                                    onClick={() => { handleDacChangeClick(value, dac) }}
                                                                >
                                                                    {t('CHANGE')}
                                                                </Button>
                                                            </div>
                                                            ...
                                                            <Form onSubmit={dacForm.handleSubmit} >
                                                                ...
                                                                <div className="d-flex justify-content-end w-40" >
                                                                    <Button disabled={dacForm.isSubmitting || !dacForm.isValid || dacForm.isValidating} className=" theme-primary-btn" type="submit">
                                                                        {t(`SAVE`)}
                                                                    </Button>
                                                                    <Button type="button" className="ml-2 bg-danger" onClick={() => { dacForm.resetForm() }}                                                            >
                                                                        {t(`CANCEL`)}
                                                                    </Button>
                                                                </div>
                                                            </Form>
