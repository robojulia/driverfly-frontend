                    ...
                    <div className=" p-3 mb-5  rounded mt-3">
                        ...
                        <ul className="p-0">
                            ...
                            <li className="row px-0">
                                ...
                                <div className="col-md-6">{job?.required_skills_other}</div>
                            </li>
                        </ul>
                    </div>
                )}
                {job?.is_orientation_needed && (
                    <div className=" p-3 mb-5  rounded mt-3">
                        ...
                        <ul className="p-0">
                            ...
                            <li className="row px-0">
                                <div className="col-md-3 font-weight-bold">{t("END_DATE")}</div>
                                <div className="col-md-6">
                                    <ShowFormattedDate
                                        hideTime
                            ...
                            <li className="row px-0">
                                <div className="col-md-3 font-weight-bold">{t("location")}</div>
                                <div className="col-md-6">
