    ...
    const popover = (
        <Popover id="popover-basic">
            ...
            <Popover.Body>
                ...
                <Link legacyBehavior href={`/dashboard/company/settings/support`}>{t("CONTACT_SUPPORT_MESSAGE_LINK")}</Link>&nbsp;
                {t("CONTACT_SUPPORT_MESSAGE_EMAIL")}&nbsp; <Link legacyBehavior href={`mailto:help@driverfly.co`}>help@driverfly.co</Link>.
            </Popover.Body>
        </Popover>
    );
