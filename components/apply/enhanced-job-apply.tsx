...
import { Input, Select, Checkbox, DhaPhoneInput, Button } from '../shared/dha';
...
export function EnhancedJobApply({ job, setEncourageModal }: EnhancedJobApplyProps) {
  ...
  const apply_form = useFormik({
    ...
    onSubmit: async (dto, { resetForm }) => {
      // First, check if phone number has conflicts
      ...
      if (!Boolean(dto?.can_pass_drug_test)) {
        ...
        try {
          ...
          trackApplicationStart(job.id, job.company?.id, {
            applicationSource: 'enhanced-quick-apply',
            additional: {
      ...
      >
        {showForm ? (
          <form onSubmit={apply_form.handleSubmit}>
                ...
                <Alert variant={hasAppliedToCurrentJob ? 'warning' : 'info'}>
                  <div className="text-center">
                    <i
                      ...
                      style={{
                        fontSize: '48px',
                        color: hasAppliedToCurrentJob ? '#ffc107' : '#17a2b8',
                      }}
                    />
                    <h5 className="mb-3">
                ...
                <div className="position-relative">
                  <DhaPhoneInput
                    ...
                    onBlur={(e) => {
                      ...
                      // Check phone number after user finishes typing
              ...
              <Col>
                <div className="border rounded p-3 mb-3">
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      <h6 className="mb-1">
                        📄 Driver's License <span className="text-muted">(Optional)</span>
                      </h6>
                    ...
                    <Button
                      variant={hasDriversLicense ? 'success' : 'outline'}
                      size="sm"
                      type="button"
            ...
            <Row className="mt-4">
              <Col>
                <h6 className="mb-3">Required Confirmations</h6>
                ...
                <div className="mb-3">
                  <Checkbox
                    ...
                    error={getErrorString(
                      apply_form.touched.can_pass_drug_test && apply_form.errors.can_pass_drug_test
                    )}
                  />
                  <small className="text-muted d-block mt-1">
                    Please be honest as {job?.company?.name || 'Country Rogue'} will require you to
                    take a pre-employment drug screening as required by DOT regulations.
                  </small>
                </div>
          ...
          <Row>
            {showDrugErrorMessage ? (
              <Col>
                <div className="text-center">
                  <h5 className="text-danger mb-3">Application Cannot Proceed</h5>
                  <p>
              ...
              <Col>
                <div className="text-center">
                  <h5 className="text-success mb-3">Application Submitted Successfully!</h5>
                  <p>
