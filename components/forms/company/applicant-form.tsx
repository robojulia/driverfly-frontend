...
export function ApplicantForm(props: ApplicantFormProps) {
  ...
  const currentCompanyCheckBox = (employerId) => {
    return curentCompanyCheck?.is_current
      ? Boolean(employerId?.id !== curentCompanyCheck?.id)
      : false;
  };
            ...
            <Row>
              <Col>
                <BaseCheck
                  ...
                  onChange={({ target: { value } }) => {
                    form.setFieldValue(`already_applied_to_company`, value);
                    if (!value) {
                    ...
                    <ViewCard
                      ...
                      actions={
                        ...
                        form?.values?.accident_count >
                          (form.values.accident_history || [])?.length && (
                          <Button
