...
export function VerificationOfEmploymentSection1({ applicant, employer }: Section1Props) {
  ...
  return (
    <>
      <Row>{t('VERIFICATION_OF_EMPLOYMENT')}</Row>
      <Row>
      ...
      <div className="Row" style={{ textAlign: 'left', marginBottom: '20px' }}>
        <div className="Col">
          <p style={{ color: 'black', fontWeight: '100', display: 'inline' }}>
            {t('EMPLOYEE_SSN:')}
          </p>
          <p style={{ color: 'black', display: 'inline' }}>
            {social_security_number || ` ${t('N/A')}`}
          </p>
        </div>
      </div>
      <Row className={styles.align__text_left}>
      ...
      <Row>
        <Col>
          <div>
            <h5 className={`${styles.paragraph} ${styles.align__text_left}`}>{t('SIGNATURE:')}</h5>
          </div>
        ...
        <Col>
          <div>
            <h5 className={`${styles.paragraph} ${styles.align__text_left}`}>{t('DATE:')}</h5>
            <p className={`${styles.paragraph} ${styles.align__text_left}`}>
      ...
      <Row className={styles.align__text_left}>
        ...
        <p className={`${styles.paragraph} ${styles.align__text_left}`}>
          {t(
            ...
            { phone: applicant?.company?.users?.[0]?.contact_number || 'N/A' },
            { translateProps: true }
          )}
        </p>
      </Row>
      ...
      <Row className={styles.align__text_left}>
        ...
        <p className={`${styles.paragraph} ${styles.align__text_left}`}>
          {t(
            ...
            { current_manager_name: employer?.manager_name },
            { translateProps: true }
          )}
        </p>
      </Row>
