    ...
    return (
        <form>
            ...
            <Row className="ml-4 mr-4">
                ...
                <Row>
                    <h5 className={`${styles.paragraph} ${styles.text__bold}`}>THE BELOW DISCLOSURE AND AUTHORIZATION LANGUAGE IS FOR MANDATORY USE BY ALL ACCOUNT HOLDERS</h5>
                </Row>
                <Row className='mt-5'>
                ...
                <Row>
                    <Col>
                        <p className={`${styles.paragraph} ${styles.text__bold} ${styles.align__text_right}`}>Applicant Name:</p>
                    </Col>
                    <Col>
                ...
                <Row>
                    <Col><p className={`${styles.paragraph} ${styles.text__bold} ${styles.align__text_right}`}>Signature</p></Col>
                    <Col><p className={`${styles.paragraph} ${styles.align__text_left}`}>Signature goes here</p></Col>
                    
                </Row>
                <Row>
                    <Col><p className={`${styles.paragraph} ${styles.text__bold} ${styles.align__text_right}`}>Date:</p></Col>
                ...
                <Row>
                    <p className={`${styles.paragraph} ${styles.align__text_left}`}>NOTICE: The prospective employment concept referenced in this form contemplates the definition of “employee” contained at 49</p>
                </Row>
                <Row>
                    <p className={`${styles.paragraph} ${styles.align__text_left}`}>C.F.R. 383.5.</p>
                </Row>
                <Row>
