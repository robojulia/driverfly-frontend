...
export function DriverLicense() {
    ...
    const isNotDriverLicense = (v: DocumentEntity): boolean => v.type != ApplicantDocumentType.DRIVERS_LICENSE;
    ...
    const form = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            ...
            if (!!document.file_base64) {
                const documents: DocumentEntity[] = applicant.documents?.filter(isNotDriverLicense)
                setApplicant({
                    ...applicant,
