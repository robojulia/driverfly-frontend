					...
					>
						<Row className="d-flex align-items-start">
							...
							<Col
								...
								className="d-flex flex-column align-items-start justify-content-start"
							>
								<h5 className={`card-title  text-muted mb-0`}>{t("EMPLOYEE_BIRTHDAYS")}</h5>
								<span className={`h2 font-weight-bold mb-0`}>
					...
					>
						<Row className="d-flex align-items-start">
							...
							<Col
								...
								className="d-flex flex-column align-items-start justify-content-start"
							>
								<h5 className={`card-title  text-muted mb-0`}>{t("ACTIVE_JOB_POSTS")}</h5>
								<span className={`h2 font-weight-bold mb-0`}>
					...
					>
						<Row className="d-flex align-items-start">
							...
							<Col
								...
								className="d-flex flex-column align-items-start justify-content-start"
							>
								<h5 className={`card-title  text-muted mb-0`}>{t("CONVERSION_RATE")}</h5>
								<span className={`h2 font-weight-bold mb-0`}>
